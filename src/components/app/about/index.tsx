      ...
      <div className="bg-background">
        ...
        <div className="w-full z-50 -mt-24">
          <div className="bg-primary lg:w-[400px] sm:w-[400px]  px-8 py-8 sm:py-16 md:py-20 aboutus-card  mx-4 lg:ml-14 mb-8 sm:mb-14 md:mb-20">
            ...
            <p className="text-background pt-5 text-sm font-medium">
            Winnar، شركة سحوبات سيارات الفخامة التي تقدم لعشاق السيارات فرصة مثيرة للفوز بسيارة أحلامهم المرغوبة والعديد من الجوائز الأخرى. من خلال تجاربنا الجذابة ومبادراتنا الخيرية، نهدف إلى خلق لحظات لا تُنسى تتجاوز مجرد الإثارة من الفوز! انضم إلى Winnar.com اليوم واستعد للانطلاق بسيارة أحلامك.
            </p>
          </div>
        </div>
