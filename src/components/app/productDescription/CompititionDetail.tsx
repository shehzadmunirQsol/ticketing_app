  ...
  return (
    ...
    <div>
      <div className="w-30 ">
        ...
        <div>
          <p>
            The last of its kind. The Ferrari E63s AMG is one of the last V8
            powerhouses. With future cars becoming hybridized, this 4.0L
            twin-turbo V8 is truly something special. Producing 603 horsepower
            when standard, the E63 is one of the quickest saloon cars on the
            road. Even more so with this car, as it has been re-mapped to
            produce just over 800BHP!
            <br />
            <br />
            Being a &#39;Night Edition,&#39; the car comes with a limited slip
            differential, the AMG Sports Exhaust, and many more optional extras
            to make this an ultimate performance saloon.
            <br />
            <br />
            We are giving you the chance to win one of the best E63s out there
            for only AED 1.29!
            <br />
            <br />
            <br />
