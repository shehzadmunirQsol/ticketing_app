  ...
  return (
    <section id="CompititionDetail">
      <div className="w-30 ">
        ...
        {dataCode ? (
          <div
            className=" relative pb-20 cmsStyle "
            dangerouslySetInnerHTML={
              {
                __html:
                  data?.EventDescription[0].comp_details ??
          ...
          <>
            <p className="lg:text-3xl text-1xl font-black mb-4">
            ...
            <div>
              <p className="leading-loose">
                ...
                twin-turbo V8 is truly something special. Producing 603
                horsepower when standard, the E63 is one of the quickest saloon
                cars on the road. Even more so with this car, as it has been
                re-mapped to produce just over 800BHP!
                <br />
                <br />
