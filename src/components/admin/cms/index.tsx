...
{
  cms ? (<>    <div className="justify-center items-center px-8 py-4">
  ...
  <div className="py-4 px-4  w-full flex flex-col lg:flex-row md:flex-row items-center justify-between flex-wrap  gap-4">
    {cms?.map((item: any, i) => {
      console.log(item, 'items');
      return (
        <div className="bg-background py-4 px-4 rounded-md xl:w-96 w-full shadow-lg flex flex-row items-center justify-between  ">
